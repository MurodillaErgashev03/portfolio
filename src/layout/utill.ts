export const findDashboardPageTitle = (path: string) => {
  ...
  if (defPath === 'realization') return 'Realizatsiya';
  else if (defPath === 'lots') return 'Lot';
  ...
  else if (defPath === 'facture') return 'Fakturalar';
  ...
  else if (defPath === 'tools') return 'Mahsulotlar';
